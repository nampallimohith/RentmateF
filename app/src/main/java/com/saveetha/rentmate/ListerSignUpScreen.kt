    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "Enter your details to manage properties",
                ...
                Column(horizontalAlignment = Alignment.Start) {
                    ...
                    OutlinedTextField(
                        ...
                        placeholder = { Text("Jane Doe", color = Color.LightGray) },
                ...
                Button(
                    onClick = {
                        if (fullName.isNotBlank() && email.isNotBlank() && phone.isNotBlank() && password.isNotBlank()) {
                            viewModel.registerUser(fullName, email, password, phone, "lister")
                        }
                    },
